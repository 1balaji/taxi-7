...
#define SHKMyAppName			@"MinskTaxi"
#define SHKMyAppURL				@"http://www.MinskTaxiApp.by"
...
#define SHKFacebookKey				@"262340837134920"
#define SHKFacebookSecret			@"bd75746257696f2126f9e86be1cc6105"
 ...
 */
#define SHKTwitterConsumerKey		@"yLgo9ZMNlEpYnBnZg0iLQ"
#define SHKTwitterSecret			@"pohiY3WUb1brC8FEhLvR5p9wt0VL40duxkUsFqa4"
#define SHKTwitterCallbackUrl		@"http://misnktaxiapp.by" // You need to set this if using OAuth, see note above (xAuth users can skip it)
